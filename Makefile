...
SRCOBJ=$(addprefix $(OBJDIR)/$(SRCDIR)/, globals.o lexer.o symbol.o symtab.o type.o)
TESTOBJ=$(addprefix $(OBJDIR)/$(TESTDIR)/, testu.o CuTest.o lexer_test.o symbol_test.o symtab_test.o type_test.o)
